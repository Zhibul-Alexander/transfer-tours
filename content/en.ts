...
const en: SiteContent = {
  ...
  transfers: {
    ...
    conditions: [
      "Payment on arrival — free booking",
      "Comfortable seating, seat belts, plenty of space for luggage and new tyres",
      "Drivers with 15+ years of experience",
      "Stops on the way if needed (coffee/restroom)",
    ],
    addonsTitle: "Extra services",
    addons: [
      "Transfer from all airports in Georgia (Tbilisi, Batumi, Kutaisi)",
